...
public class StringFormatter {
	private static DecimalFormat	df_standart	= new DecimalFormat(
														"#0.00",
														DecimalFormatSymbols
																.getInstance(Locale.US));
	private static DecimalFormat	df_extra	= new DecimalFormat(
														"#0.00",
														DecimalFormatSymbols
																.getInstance(Locale.US));
	...
	public static String format(double value, int integerDigit,
			int fractionDigit) {
